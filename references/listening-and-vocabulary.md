...
When vocabulary support is necessary, use an English phrase and a very short easy-English meaning. Keep scene introductions and all coach explanations in English, even when another language is requested. Do not provide candidate answers before the learner tries. Do not read all examples or an itinerary. Then begin with one easy role line and listen. If the learner already knows an item, skip it. A third useful item can wait until it becomes relevant. The learner does not need to pass a vocabulary test to enter the scene.

## Make each exchange usable
...
## Preserve useful words without flooding the deck
