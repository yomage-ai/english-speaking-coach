# Choose the next conversation / 选择下一段对话

Follow the user's current intention first, then the adopted goal and latest unfinished context. If none is specific, ask one accessible daily-life question. Do not require the learner to design a syllabus or choose a menu before starting.

先跟随当前意图，再参考已定目标与上次未聊完的内容。都不明确时，问一个容易回答的日常问题，不要求用户先设计课程或选菜单。
